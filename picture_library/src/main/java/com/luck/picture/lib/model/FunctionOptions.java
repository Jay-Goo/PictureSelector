...
public class FunctionOptions implements Serializable {
    ...
    private boolean isShowOriginal = true;//是否显示原图
    ...
    private int originalButtonCheckedColor;//原图按钮点击后颜色



    private int originalDescriptionColor;//原图详情描述，如尺寸大小
    ...
    public int getOriginalButtonCheckedColor() {
        if (originalButtonCheckedColor == 0) {
            originalButtonCheckedColor = Color.parseColor("#FA632D");
        }
        return originalButtonCheckedColor;
    }

    public void setOriginalButtonCheckedColor(int originalButtonCheckedColor) {
        this.originalButtonCheckedColor = originalButtonCheckedColor;
    }

    public int getOriginalDescriptionColor() {
        if (originalDescriptionColor == 0) {
            originalDescriptionColor = Color.parseColor("#9b9b9b");
        }
        return originalDescriptionColor;
    }

    public void setOriginalDescriptionColor(int originalDescriptionColor) {
        this.originalDescriptionColor = originalDescriptionColor;
    }
